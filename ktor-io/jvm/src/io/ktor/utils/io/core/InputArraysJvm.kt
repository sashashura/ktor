...
public fun DROP_Input.readFully(dst: ByteBuffer, length: Int = dst.remaining()) {
...
@Suppress("EXTENSION_SHADOWED_BY_MEMBER")
public fun DROP_Input.readAvailable(dst: ByteBuffer, length: Int = dst.remaining()): Int {
    var bytesCopied = 0
