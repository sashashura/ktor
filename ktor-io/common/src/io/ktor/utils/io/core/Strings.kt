 ...
 */
public fun DROP_ByteReadPacket.readUTF8Line(estimate: Int = 16, limit: Int = Int.MAX_VALUE): String? {
 ...
 * (does fail once limit exceeded) or return `null` if the packet is empty
 */
public fun DROP_Input.readUTF8Line(estimate: Int = 16, limit: Int = Int.MAX_VALUE): String? {
    val sb = StringBuilder(estimate)
    return if (readUTF8LineTo(sb, limit)) sb.toString() else null
}
 ...
 * is empty
 */
public fun DROP_Input.readUTF8LineTo(out: Appendable, limit: Int): Boolean {
    var decoded = 0
    var size = 1
    var cr = false
    var end = false
 ...
 */
@Suppress("unused")
public fun DROP_Input.readUTF8UntilDelimiter(delimiters: String, limit: Int = Int.MAX_VALUE): String {
    return buildString {
 ...
 */
public fun DROP_Input.readUTF8UntilDelimiterTo(out: Appendable, delimiters: String, limit: Int = Int.MAX_VALUE): Int {
    var decoded = 0
    var delimiter = false
 ...
 * @returns number of characters copied (possibly zero)
 */
public fun DROP_Input.readUTF8UntilDelimiterTo(out: DROP_Output, delimiters: String, limit: Int = Int.MAX_VALUE): Int {
 ...
 */
public fun DROP_ByteReadPacket.readBytes(
 ...
 */
public fun DROP_Input.readBytes(n: Int): ByteArray = readBytesOf(n, n)

/**
 * Reads all remaining bytes from the input
 */
public fun DROP_Input.readBytes(): ByteArray = readBytesOf()
 ...
 */
public fun DROP_Input.readBytesOf(min: Int = 0, max: Int = Int.MAX_VALUE): ByteArray = if (min == max && min == 0) {
    EmptyByteArray
} else if (min == max) {
 ...
 */
public fun DROP_Input.readText(out: Appendable, charset: Charset = Charsets.UTF_8, max: Int = Int.MAX_VALUE): Int {
...
public fun DROP_Input.readText(decoder: CharsetDecoder, max: Int = Int.MAX_VALUE): String {
 ...
 * @return a decoded string
 */
public fun DROP_Input.readText(charset: Charset = Charsets.UTF_8, max: Int = Int.MAX_VALUE): String {
 ...
 * @return a decoded string
 */
public fun DROP_Buffer.readText(charset: Charset = Charsets.UTF_8, max: Int = Int.MAX_VALUE): String = buildString {
...
public fun DROP_Input.readTextExact(charset: Charset = Charsets.UTF_8, n: Int): String {
 ...
 */
public fun DROP_Input.readTextExactCharacters(charactersCount: Int, charset: Charset = Charsets.UTF_8): String {
...
public fun DROP_Input.readTextExactBytes(charset: Charset = Charsets.UTF_8, bytes: Int): String {
 ...
 */
public fun DROP_Input.readTextExactBytes(bytesCount: Int, charset: Charset = Charsets.UTF_8): String {
 ...
 */
public fun DROP_Output.writeText(
    text: CharSequence,
    fromIndex: Int = 0,
...
private fun DROP_Output.writeTextUtf8(text: CharSequence, fromIndex: Int, toIndex: Int) {
    var index = fromIndex
...
private fun DROP_Input.readUTFUntilDelimiterToSlowAscii(delimiters: String, limit: Int, out: DROP_Output): Int {
    var decoded = 0
    var delimiter = false
...
private fun DROP_Input.readUTF8UntilDelimiterToSlowUtf8(
    out: DROP_Output,
    delimiters: String,
    limit: Int,
    decoded0: Int
